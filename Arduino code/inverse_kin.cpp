...
int inverse_kin :: calculations(float position_data[3], float (&fi_array)[3])
{
    ...
    float Gi[3] = {square(x) + square(y) + square(z) + square(a) + square(Length) + 2 * y * a - square(length), square(x) + square(y) + square(z) + square(b) + square(c) + square(Length) + 2 * x * b + 2 * y * c - square(length), square(x) + square(y) + square(z) + square(b) + square(c) + square(Length) - 2 * x * b + 2 * y * c - square(length)};
